...
""" Code owned by © Copyright 2023, LangChain Inc. """
...
class SemanticChunker(BaseDocumentTransformer):
    ...
    #Added by Ptandan (Takes in the sentences rather than split the text here.)
    def split_text_modified(self, single_sentences_list, block_marker_indices):
        # Splitting the essay (by default on '.', '?', and '!')
        # single_sentences_list = re.split(self.sentence_split_regex, text)
        ...
        for index in indices_above_thresh:
            ...
            #update the indices
            segment_indices.append(end_index)
        ...
        #accounting for the blocks in the text
        predicted_segmentation = [0] * len(single_sentences_list)
        ...
        return predicted_segmentation, chunks
