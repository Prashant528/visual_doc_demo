...
- Every Third Thursday at our [monthly community meeting](https://docs.google.com/document/d/1VQDIAB0OqiSjIHI8AWMvSdceWhnz56jNpZrLs6o7NJY/edit#) over [zoom](https://zoom.us/my/kubernetescommunity) at [10am US Pacific Time](https://www.thetimezoneconverter.com/?t=10:00&tz=PT%20%28Pacific%20Time%29)

- Intro sessions at KubeCon/CloudNativeCon live or [recordings on YouTube](https://www.youtube.com/channel/UCvqbFHwN-nwalWPjPUKpvTA)
...
- KEPs[(Kubernetes Enhancement Proposals)](https://git.k8s.io/enhancements/keps)
- We don't recommend following or watching any repository unless you are using
THIS IS END BLOCK MARKER.
[heavy email filters](./best-practices.md). Getting involved with the community
...
[Join](http://slack.k8s.io) | [Slack Guidelines](/communication/slack-guidelines.md) | [slack moderators](./moderators.md#slack) | [#kubernetes-contributors](https://app.slack.com/client/T09NY5SBT/C09R23FHP)
...
THIS IS START BLOCK MARKER.
- [kubernetes-announce](https://groups.google.com/forum/#!forum/kubernetes-announce) broadcasts major project announcements such as releases
THIS IS END BLOCK MARKER.
and security issues
...
- [Discuss Kubernetes](https://discuss.kubernetes.io) is a forum where Kubernetes users trade notes with sections
THIS IS END BLOCK MARKER.
...
THIS IS END BLOCK MARKER.
community group as noted above.  These are linked from the [SIG list](/sig-list.md).
Calendar & Meetings
We use Zoom for all of our community group meetings and contributor programs. -
[Zoom Guidelines](./zoom-guidelines.md)
We keep a [shared calendar](https://calendar.google.com/calendar/embed?src=calendar%40kubernetes.io) with all of our community group meetings. If you'd
like a contributor event published, please reach out to [#sig-contribex](https://app.slack.com/client/T09NY5SBT/C1TU9EB9S) on slack.
Website
Documentation is published at [https://kubernetes.io](https://kubernetes.io) - [website guidelines](./website-guidelines.md)
Social Media & Blogs
Twitter
THIS IS START BLOCK MARKER.
- [@kubernetesio](https://twitter.com/kubernetesio)
- owned and operated by CNCF. Contact: [social@cncf.io](mailto:social@cncf.io)

- [Last Week in Kubernetes Development](http://lwkd.info/)
- owned and operated by [Josh Berkus](https://github.com/jberkus)
THIS IS END BLOCK MARKER.
YouTube
Owned and operated by sig-contribex [community management](/sig-contributor-experience#community-management) subproject.
[Kubernetes Community channel](https://www.youtube.com/c/kubernetescommunity) - recordings of community group meetings, Thursday
...
try to post on discuss.kubernetes.io or if you think you found a bug, please [file an issue](https://github.com/kubernetes/kubernetes/issues/new).
Other
THIS IS START BLOCK MARKER.
- [r/kubernetes](https://www.reddit.com/r/kubernetes/) - reddit channel owned and operated by community members and
THIS IS END BLOCK MARKER.
...
THIS IS START BLOCK MARKER.
- [LWKD](https://lwkd.info) - a weekly newsletter that summarizes changes to Kubernetes code, development,
THIS IS END BLOCK MARKER.
...
Information about these and other community events is available on the CNCF [events](https://www.cncf.io/events/)
pages.
