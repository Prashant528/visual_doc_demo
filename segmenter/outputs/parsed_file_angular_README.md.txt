...
This would start a development server that you can access on [http://localhost:4200](http://localhost:4200). In development, Angular DevTools
...
`dist/bin/devtools/projects/shell-browser/src/prodapp` directly.THIS IS END BLOCK MARKER.
