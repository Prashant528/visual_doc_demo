...
environment.
--------
Note that all commands should be executed in the repository root, not
--------
`devtools/`.
--------
All file paths are also relative to the repository root.
--------
Debian Linux, MacOS, and Windows via WSL should build successfully.
--------
Building
natively on Windows without WSL is not supported at the moment.
--------
To set up your development environment, first install the [correct version of Node](/.nvmrc).
--------
If you have
...
```
--------
This would start a development server that you can access on [http://localhost:4200](http://localhost:4200).
--------
In development, Angular DevTools
uses a "development shell."
--------
This is different from "chrome shell" in a way, that it runs the user's app in an iframe.
--------
...
--------
You'll have to select the manifest file in
